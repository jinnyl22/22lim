const canvas2 = document.getElementById('_stg1');
...
const stuffsMapSt2 = createStuffObj(stuffsStg1, c, offsetSt1);
console.log(stuffsMapSt1);

const portalsMapSt2 = createPortalObj(portalsStg1, c, offsetSt1);
